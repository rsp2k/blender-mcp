...
description: "Two client styles: direct dispatch tool calls (simple) vs custom _message_bus subscription (advanced). Pick the right one."
---
...
| Need | Style A (direct calls) | Style B (custom subscription) |
|------|------------------------|-------------------------------|
